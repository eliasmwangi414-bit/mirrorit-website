...
<head>
  ...
  <title>{title} | MIRROR-IT Services</title>
  ...
  <style>
    ...
    *, *::before, *::after {{ box-sizing: border-box; margin: 0; padding: 0; }}
    ...
    @media (max-width: 900px) {{ 
      ...
      .detail-row, .detail-row:nth-child(even) {{ flex-direction: column; gap: 40px; margin-bottom: 60px; }}
...
<body>
  ...
  <section class="service-hero">
    ...
    <img src="https://placehold.co/1200x600?text={title_encoded}" alt="{title}" class="service-hero-img" />
  </section>
...
for filename, title, subtitle, sections in services:
    ...
    for idx, (sec_title, sec_desc) in enumerate(sections):
        wa_message = f"Hello MIRROIT! I am inquiring about {title} - {sec_title}."
