...
pages = [
    ...
    ("furniture.html", "Mirror Furniture", "Mirror Furniture")
]
...
<body>
  ...
  <section class="gallery-section">
    <div class="gallery-header">
      <h1 class="gallery-title">{display_name} Gallery</h1>
      <p style="color: #a0a0a0;">Browse through our collection of {title_lower}.</p>
    </div>
    <div class="gallery-grid" id="dynamic-product-grid">
  ...
  <footer>
    <div class="footer-grid">
      <div class="footer-brand">
        <a href="index.html" class="nav-logo" style="display:inline-flex; margin-bottom:0; text-decoration:none;">
          <img src="images/logo.png" class="logo-img" style="height: 40px; width: 40px; border-radius: 50%; object-fit: contain; flex-shrink: 0; display: block;" alt="MIRRORIT logo" />
          <div class="logo-text-wrap" style="display: flex; flex-direction: column; justify-content: center; margin-left: 12px;">
            <span class="logo-text" style="color: #ffffff; font-family: 'Cinzel', serif; font-size: 20px; font-weight: 800; letter-spacing: 1px; line-height: 1;">MIRRORIT</span>
            <span class="logo-tagline" style="color: rgba(255,255,255,0.45); font-family: 'Montserrat', sans-serif; font-size: 8px; font-weight: 600; letter-spacing: 1.5px; text-transform: uppercase; margin-top: 2px;">You Are Enough</span>
          </div>
        </a>
        <p>We make custom mirrors that fit your space perfectly. Hand-cut and fitted locally in Nairobi.</p>
      ...
      <div>
        ...
        <ul class="footer-links">
          ...
          <li><a href="#">Next to Gertrude's Hospital</a></li>
  ...
  <script>
    ...
    async function loadPageContent() {{
      ...
      // Build cards: ONLY show uploaded images (no placeholder slots)
      let html = '';
      if (gallery.length === 0) {{
        html = '<div style="grid-column: 1/-1; text-align: center; padding: 80px 24px; color: #777; font-family: var(--font-body); font-size: 15px;">No products uploaded yet. Check back soon!</div>';
      }} else {{
        gallery.forEach((img, idx) => {{
          const num = idx + 1;
          const waMsg = encodeURIComponent('Hello MIRRORIT! I am inquiring about: ' + DISPLAY_NAME + ' #' + num + '.');
          const waUrl = 'https://wa.me/254794439669?text=' + waMsg;
          const src = img.path;
...
for filename, mirror_type, display_name in pages:
