...
pages = [
    ("wooden-framed.html", "Wooden Framed Mirrors"),
    ("thin-framed.html", "Thin Framed Mirrors"),
    ("frameless.html", "Frameless Mirrors"),
    ("wall-mirrors.html", "Wall Mirrors"),
    ("aluminium-framed.html", "Aluminium Framed Mirrors"),
    ("smart-mirrors.html", "Smart Mirrors"),
    ("vanity.html", "Vanity Mirrors"),
    ("accent.html", "Accent Mirrors"),
    ("custom.html", "Custom Mirrors")
]
...
<head>
  ...
  <style>
    ...
    *, *::before, *::after {{ box-sizing: border-box; margin: 0; padding: 0; }}
    ...
    @media (max-width: 768px) {{
      .product-desc, .product-link {{ opacity: 1; transform: translateY(0); }}
    }}
  </style>
</head>
<body>
  ...
  <section class="gallery-section">
    <div class="gallery-header">
      <h1 class="gallery-title">{title} Gallery</h1>
      <p style="color: #a0a0a0;">Browse through our collection of {title_lower}.</p>
    </div>
    ...
    <div class="footer-grid">
      <div class="footer-brand">
        ...
        <div class="footer-socials">
          <a href="#" class="social-btn" id="facebook-btn" title="Facebook">f</a>
          <a href="#" class="social-btn" id="instagram-btn" title="Instagram">in</a>
          <a href="#" class="social-btn" id="twitter-btn" title="Twitter / X">ð•</a>
          <a href="#" class="social-btn" id="whatsapp-btn" title="WhatsApp">W</a>
        </div>
      </div>
      <div>
        <div class="footer-col-title">Our Mirrors</div>
        <ul class="footer-links">
          <li><a href="led-backlit.html">LED Backlit Mirrors</a></li>
          <li><a href="front-lit.html">Front-Lit Mirrors</a></li>
          <li><a href="hollywood-vanity.html">Hollywood Vanity Mirrors</a></li>
          <li><a href="oval-led.html">Oval LED Mirrors</a></li>
          <li><a href="round-led.html">Round LED Mirrors</a></li>
          <li><a href="leather-strap.html">Leather-Strap Mirrors</a></li>
          <li><a href="custom-size.html">Custom-Size Mirrors</a></li>
        </ul>
      </div>
      <div>
      ...
      <div>
        ...
        <ul class="footer-links">
          <li><a href="tel:+254794439669">+254 718 850 862</a></li>
          <li><a href="mailto:sales@abritglass.co.ke">sales@abritglass.co.ke</a></li>
...
for filename, title in pages:
    placeholders_html = ""
    for i in range(1, 31):
        message = f"Hello MIRROIT! I am inquiring about: {title} #{i}."
        from urllib.parse import quote
        wa_url = f"https://wa.me/254794439669?text={quote(message)}"
        
        placeholders_html += f'''
      <div class="product-card" onclick="window.open('{wa_url}', '_blank')">
        <img src="https://placehold.co/600x600?text={title.replace(" ", "+")}+{i}" alt="{title} {i}" class="product-card-img" />
        <div class="product-card-overlay"></div>
        <div class="product-card-content">
          <div class="product-name">{title} #{i}</div>
          <p class="product-desc">Premium {title.lower()} custom fabricated to your exact specifications. Contact us to order.</p>
          <a href="{wa_url}" class="product-link" target="_blank" rel="noopener noreferrer">
...
'''
    ...
    html_content = template.format(title=title, title_lower=title.lower(), placeholders=placeholders_html)
